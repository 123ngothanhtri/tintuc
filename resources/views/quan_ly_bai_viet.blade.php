    ...
    <div class="w-full p-5">
        ...
        <table class="table bg-white w-full my-5">
            ...
            <tr>
                ...
                <td class="p-2 border">
                    <img width="100px" height="100px" src="{{ $t->hinhanh_baiviet }}" alt="ảnh">
                </td>
                <td class="p-2 border">
                ...
                <td class="p-2 border">
                    <a href="{{ url('sua-bai-viet/'.$t->id_baiviet) }}" > <button class="bg-gray-100 p-1 rounded-lg outline-none border-none hover:bg-blue-200 ring-none text-blue-500">Sửa</button> </a>
